...
<body>
	...
	<div class="container-contact100" style="background-image: url('images_add/bg-01.jpg');">
		<div class="wrap-contact100" >
			...
			<div class="r">
				<div class="contact100-form-radio">
					<input  class = "in" <?php echo ($MA101 === 1) ? 'checked' : '';?> id="checkbox1"  type="checkbox" name="course[]" value="MA_101">
				...
				<div class="contact100-form-radio">
					<input  class = "in" <?php echo ($BB101 === 1) ? 'checked' : '';?> id="checkbox2"  type="checkbox" name="course[]" value="BB_101">
				...
				<div class="contact100-form-radio">
					<input class = "in" id="checkbox3" <?php echo ($PH101 === 1) ? 'checked' : '';?>  type="checkbox" name="course[]" value="PH_101">
