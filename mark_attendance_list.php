...
<body>
  <div class="container-contact100" style="background-image: url('images_add/bg-01.jpg');">
    ...
    <table class = "table table-hover"><thead class="table-dark"><tr><th scope="col">Course Name</th><th scope="col">Mark Attendance</th></tr></thead><tbody>
    ...
    if ($result->num_rows > 0) {
       while($row = $result->fetch_assoc()) {
        ...
        echo '<td><form action="mark_attendance.php" method="post"><button type="submit" class="btn btn-outline-primary" name="course" value="'.$row["course_name"].'">MARK</button></form></td></tr>';
        }
  }
  $conn->close();
