...
<html lang="en">
<head>
	<title>GENERATE FACULTY ID CARD</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="container-contact100" style="background-image: url('images_add/bg-01.jpg');">
		<div class="wrap-contact100" >
			<form class="contact100-form validate-form" action="admin_faculty_id_db.php" method="post">
				<span class="contact100-form-title">
					ENTER FACULTY ID
				</span>
				<div class="wrap-input100 validate-input bg1" data-validate="Please Type Faculty ID">
					<span class="label-input100">ID</span>
					<input class="input100" type="number" name="RollNo" placeholder="Enter Faculty ID" >
				</div>
